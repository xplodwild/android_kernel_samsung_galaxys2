...
/* USB2.0 OTG Controller register */
#define S3C_USBOTGREG(x) ((x) + S3C_VA_HSDEVICE)
...
/* S3C_UDC_OTG_DIEPCTL0/DOEPCTL0 device control IN/OUT
...
/* S3C_UDC_OTG_DIEPCTLn/DOEPCTLn device control IN/OUT
...
#endif /* __ASM_ARCH_REGS_USB_OTG_HS_H */
