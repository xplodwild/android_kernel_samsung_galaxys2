...
#define EXYNOS4_GPIO_MP00_NR (6)
#define EXYNOS4_GPIO_MP01_NR (4)
#define EXYNOS4_GPIO_MP02_NR (6)
...
enum s5p_gpio_number {
	...
	EXYNOS4_GPIO_MP00_START = EXYNOS4_GPIO_NEXT(EXYNOS4_GPIO_Z),
	EXYNOS4_GPIO_MP01_START = EXYNOS4_GPIO_NEXT(EXYNOS4_GPIO_MP00),
	EXYNOS4_GPIO_MP02_START = EXYNOS4_GPIO_NEXT(EXYNOS4_GPIO_MP01),
};
...
#define EXYNOS4_MP00(_nr)	(EXYNOS4_GPIO_MP00_START + (_nr))
#define EXYNOS4_MP01(_nr)	(EXYNOS4_GPIO_MP01_START + (_nr))
#define EXYNOS4_MP02(_nr)	(EXYNOS4_GPIO_MP02_START + (_nr))

/* the end of the EXYNOS4 specific gpios */
#define EXYNOS4_GPIO_END	(EXYNOS4_GPZ(EXYNOS4_GPIO_MP02_NR) + 1)
#define S3C_GPIO_END		EXYNOS4_GPIO_END

/* define the number of gpios we need to the one after the GPZ() range */
#define ARCH_NR_GPIOS		(EXYNOS4_GPZ(EXYNOS4_GPIO_MP02_NR) +	\
